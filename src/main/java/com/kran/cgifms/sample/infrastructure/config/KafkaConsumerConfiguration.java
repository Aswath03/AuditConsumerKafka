package com.kran.cgifms.sample.infrastructure.config;
...
public class KafkaConsumerConfiguration {
	...
	@Bean
	public ConsumerFactory<String, KafkaDTO> consumerFactoryAudit() {
		...
		props.put(ConsumerConfig.GROUP_ID_CONFIG, "IFMS_CORE");
	...
	@Bean
	public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, KafkaDTO>> kafkaListenerContainerFactoryAudit() {
		ConcurrentKafkaListenerContainerFactory<String, KafkaDTO> factory = new ConcurrentKafkaListenerContainerFactory<>();
		factory.setConsumerFactory(consumerFactoryAudit());
